...
# --------------------------------------------------------Fetching and Storing in MongoDb---------------------------------------------------------
st.header('Data collection')
st.subheader ('Fetches the data using channel ID')
channel_id = st.text_input('Enter the channel_id :')
Get_data = st.button('**Fetch and Store**')
...
st.subheader('''Data stored in MongoDb is migrated to MySql''')
...
st.subheader("Channel's Analysis")
